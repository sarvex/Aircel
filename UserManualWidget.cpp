    ...
    : QWidget(parent)
{
    ...
    this->list->item (6)->setToolTip ("Data Usage");
    this->list->item (7)->setToolTip ("Check Balance");
    this->list->item (8)->setToolTip ("Online Upgrade");
    this->list->item (9)->setToolTip ("Information");
    this->list->item (10)->setToolTip ("Security Settings");
    this->list->item (11)->setToolTip ("FAQs");
