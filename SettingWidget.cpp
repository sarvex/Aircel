    ...
    : QWidget(parent)
{
    ...
    this->list->item (0)->setToolTip ("Data Usage");
    this->list->item (1)->setToolTip ("Check Balance");
    this->list->item (2)->setToolTip ("SMS Settings");
    this->list->item (3)->setToolTip ("Network Settings");
    this->list->item (4)->setToolTip ("Operators/Product Informations");
    this->list->item (5)->setToolTip ("PIN Operations");
    this->list->item (6)->setToolTip ("About PocketInternet SUPER PRO 3G");
    this->list->item (7)->setToolTip ("User Manual");
