      ...
      outgoingCall (false)
{
    ...
    this->write (At::setContactMemorySim);
    ...
    this->write (At::setApplicationMessage);
        ...
        const QByteArray& value)
{
    ...
    response.remove (At::setContactMemorySim);
    ...
    response.remove (At::setApplicationMessage);
    ...
    foreach (QString item, list )
    {
        ...
        else if (item.contains (At::applicationMessageRecieved))
        {

            item = item.remove (At::applicationMessageRecieved)
                   .remove (QUOTES).trimmed ();
