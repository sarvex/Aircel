        ...
        connectionState, DWORD error)
{
    ...
    if (longParameter)
    {
                                               ...
                                               errorMessageSize))
        {
            ...
            DeamonConnection::getInstance ()->error(
                        longParameter,
        ...
        DeamonConnection::getInstance ()->connected (false);
    ...
    switch (rasConnectionState)
    {
        ...
        case RASCS_Connected: {
            qDebug () << "Connected";
            DeamonConnection::getInstance ()->connected (true);
        }break;
