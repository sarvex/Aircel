...
CheckBalanceWidget::CheckBalanceWidget (
    ...
    : QLabel(parent)
{
    this->prepaidLabel = new QLabel (tr ("Prepaid Account Balance"));

    this->checkButton = new QPushButton (tr ("Check"));
    this->checkButton->setEnabled(false);

    this->serviceLine = new QLineEdit;
    ...
    QObject::connect (this->serviceLine,
                      ...
                      this,
                      SLOT(onServiceLineTextChanged (QString)));
